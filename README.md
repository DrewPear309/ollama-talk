...
2. Enter your chosen Ollama model on line 16 in ollama-talk.py.
3. frames_per_buffer on line 56 can be adjusted upwards if your machine can handle it. Try 8000.
