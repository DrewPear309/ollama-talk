...
def chat_with_voice():
    ...
    chat_log_file = open("history/chat_log.html", "w")
    chat_log_file.write("""
    <html>
    <head>
        ...
        try:
            ...
            if recognizer.AcceptWaveform(data):
                ...
                if user_input:
                    ...
                    print(f"{current_datetime} You said: {user_input}")
                    chat_log_file.write(f"<p class='timestamp'>{current_datetime}</p><p class='user-input'>You said: {user_input}</p>\n")
                    chat_log_file.flush()
                    ...
                    print(f"{current_datetime} AI: {ai_response}")
                    chat_log_file.write(f"<p class='timestamp'>{current_datetime}</p><p class='ai-response'>AI: {ai_response}</p>\n")
                    chat_log_file.flush()
